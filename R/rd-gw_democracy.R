...
#' \pkg{democracyData} package. That is version 0.7.1. The Varieties of Democracy
...
#' the latest years in the sample, run a `pnorm()` on the values returned for
